...
public class Salle {
    ...
    @Enumerated(EnumType.STRING) // Hibernate doit stocker l'Enum sous forme de String
    @Column(name = "type_salle", columnDefinition = "type_salle_enum") // Indiquer explicitement l'Enum PostgreSQL
